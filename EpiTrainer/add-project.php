...
$(document).ready(function(){
        ...
        $("#li-addproject").addClass("active");
});
document.title = "Add Project | EpiTrainer";
</script>

<h1 class="heading-top">New Project</h1>
<div class="content">
  ...
  if ($class_id == "") {
    ...
    display_form();
        ...
        if($add){
          ...
          PersonModel::redirect("add-project.php");
        }
        else{
